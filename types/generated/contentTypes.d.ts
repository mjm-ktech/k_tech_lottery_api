...
export interface ApiLotteryResultLotteryResult extends Schema.CollectionType {
  ...
  info: {
    singularName: 'lottery-result';
    pluralName: 'lottery-results';
    displayName: 'K\u1EBFt qu\u1EA3 x\u1ED5 s\u1ED1 mi\u1EC1n B\u1EAFc';
    description: '';
  };
  options: {
    draftAndPublish: false;
...
export interface ApiPredictedResultPredictedResult
  extends Schema.CollectionType {
  collectionName: 'predicted_results';
  info: {
    singularName: 'predicted-result';
    pluralName: 'predicted-results';
    displayName: 'K\u1EBFt qu\u1EA3 d\u1EF1 \u0111o\u00E1n';
    description: '';
  };
  options: {
    draftAndPublish: false;
